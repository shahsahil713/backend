...
export class UserController {
    ...
    private updateUser = async (request: Request, response: Response) => {
        ...
        const user = await this._userManager.updateUserById(request.params.userId, request.body);
        response.send(user);
    }
    ...
    private updateProfile = async (request: Request, response: Response) => {
        const requestUser = request.user as User;
        const user = await this._userManager.updateUserById(requestUser.id,request.body);
        response.send(user);
    }
